...
DATA_DIR = PROJECT_ROOT / "training" / "my_data2"
MODEL_PATH = PROJECT_ROOT / "inference" / "model2_sklearn.joblib"
...
def main() -> None:
    ...
    """
    texts, labels = load_labeled_texts(str(DATA_DIR), TYPE_LABEL_NAMES)
